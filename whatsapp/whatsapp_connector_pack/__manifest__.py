...
# =====================================================================================
{
    ...
    'summary': 'Pack of modules to Send WhatsApp message from many places with Templates (Sale, Invoice, Purchase, CRM Leads, Product, Stock Picking, Partner). ChatRoom 2.0.',
    ...
    'price': 0.0,
    'currency': 'USD',
    'images': ['static/description/Banner_PACK_v6.png'],
