...
class SaleOrder(models.Model): 
    ...
    delivery_percentage = fields.Float('Delivery %', compute='_compute_deliver_percentage', store=True)
    ...
    def _compute_deliver_percentage(self): 
        ...
        self.delivery_percentage = dlv_percentage / qty_percentage if qty_percentage > 0 else 0.0
